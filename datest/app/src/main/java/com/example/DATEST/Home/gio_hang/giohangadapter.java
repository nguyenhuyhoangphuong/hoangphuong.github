...
//                    Glide.with(fragment.getContext()).load(san_pham.getHinhanh()).error(R.drawable.img1).into(holder.img);
                    ...
                    builder.setMessage("Bạn có muốn xóa sản phẩm này ko")
                            .setPositiveButton("Xóa", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    API.API.Deletegiohang(giohang.getIdgh()).enqueue(new Callback<com.example.DATEST.models.giohang>() {
                                        @Override
    ...
    private void put(int tongtien, giohang giohang,int sl) {
        ...
        API.API.Putgiohang(giohang.getIdgh(), giohang1).enqueue(new Callback<com.example.DATEST.models.giohang>() {
            @Override
            public void onResponse(Call<com.example.DATEST.models.giohang> call, Response<com.example.DATEST.models.giohang> response) {
