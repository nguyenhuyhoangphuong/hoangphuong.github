package com.example.DATEST.Home.gio_hang;
                        ...
                        public void onResponse(Call<List<giohang>> call, Response<List<giohang>> response) {
                            if (response.isSuccessful()) {
                                ...
                                for (giohang d:arrayList){
                                    ...
                                    API.API.Postdonhang(donhang).enqueue(new Callback<com.example.DATEST.models.donhang>() {
                                        @Override
                                        public void onResponse(Call<com.example.DATEST.models.donhang> call, Response<com.example.DATEST.models.donhang> response) {
                                            if (response.isSuccessful()){

                                                giohang giohang=new giohang(d.getIdgh(),d.getIdtk(),d.getIdsp(),d.getSl(),d.getChon(),d.getGiax1(),d.getTongtien(),"đơn hàng");
                                                API.API.Putgiohang(d.getIdgh(),giohang).enqueue(new Callback<com.example.DATEST.models.giohang>() {
                                                    @Override
                                        ...
                                        @Override
                                        public void onFailure(Call<com.example.DATEST.models.donhang> call, Throwable t) {
                                            dialog.dismiss();
