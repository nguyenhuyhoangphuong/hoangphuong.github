...
public class chon_adpater extends RecyclerView.Adapter<chon_adpater.chonloai_viewholder> {
    ...
    gettien gettien;
    ArrayList<String> chonchon = new ArrayList<>();
                ...
                holder.checkBox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (holder.checkBox.isChecked()) {
                            chonchon.add(holder.checkBox.getText().toString());
                            tong= tong+Integer.parseInt(chon.getTien());
                            Log.e("tong",""+tong);
                        } else {
                            chonchon.remove(holder.checkBox.getText().toString());
                            tong= tong-Integer.parseInt(chon.getTien());
                            Log.e("tong",""+tong);
                        }

                        quantilist.onlist(chonchon);
