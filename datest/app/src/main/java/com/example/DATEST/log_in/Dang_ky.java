...
public class Dang_ky extends Fragment {
    ...
    private void onclick() {
        ...
        btndk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (taikhoan1.isEmpty() && hoten1.isEmpty() && mk1.isEmpty()) {
                    dialog.dismiss();
                    ...
                    API.API.kiemtra(taikhoan1, mk1).enqueue(new Callback<List<taikhoan>>() {
                        ...
                        public void onResponse(Call<List<taikhoan>> call, Response<List<taikhoan>> response) {
                            if (!response.isSuccessful()) {
                                taikhoan taikhoan = new taikhoan(0, taikhoan1, hoten1, mk1,"Thêm số điện thoại","Thêm địa chỉ");
                                API.API.post_tk(taikhoan).enqueue(new Callback<List<com.example.DATEST.models.taikhoan>>() {
                                    @Override
                                    public void onResponse(Call<List<com.example.DATEST.models.taikhoan>> call, Response<List<com.example.DATEST.models.taikhoan>> response) {
                                        if (response.isSuccessful()) {
                                            dialog.dismiss();
                                    ...
                                    @Override
                                    public void onFailure(Call<List<com.example.DATEST.models.taikhoan>> call, Throwable t) {
                                        dialog.dismiss();
                                        Log.e("lỗi đăng ký", "" + t);
                                    }
                                });
    ...
    private void anhxa(View view) {
        ...
        taikhoan = view.findViewById(R.id.taikhoandk);
