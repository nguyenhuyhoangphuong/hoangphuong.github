...
public class choxacnhan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_choxacnhan, container, false);
    }
    ...
    private void getdata() {
        API.API.getadhllsp(idtk,"Chờ duyệt").enqueue(new Callback<List<donhang>>() {
            @Override
            public void onResponse(Call<List<donhang>> call, Response<List<donhang>> response) {
                if (response.isSuccessful()){
                    ...
                    sl=donhangs.size();
                    dondagiao_adapteter=new dondagiao_adapteter(donhangs,choxacnhan.this);
