    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btndn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                API.API.Puttk(idtk, taikhoan).enqueue(new Callback<com.example.DATEST.models.taikhoan>() {
                    @Override
                    public void onResponse(Call<com.example.DATEST.models.taikhoan> call, Response<com.example.DATEST.models.taikhoan> response) {
                    ...
                    @Override
                    public void onFailure(Call<com.example.DATEST.models.taikhoan> call, Throwable t) {
        ...
        API.API.gettt(idtk).enqueue(new Callback<taikhoan>() {
            ...
            public void onResponse(Call<taikhoan> call, Response<taikhoan> response) {
                if (response.isSuccessful()) {
                    ...
                    email.setText(taikhoan.getTaikhoan());
                    mk = taikhoan.getMk();
